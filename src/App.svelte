<script>
  ...
  function onButtonPressed(index) {
    switch (index) {
      case 0:
        ledDisplay.setValue("hello");
        break;
      case 1:
        ledDisplay.setValue("abcdefgh");
        break;
      case 2:
        ledDisplay.setValue("12345678");
        break;
      case 3:
        ledDisplay.setValue("1-2-3-4");
        break;
      case 4:
        ledDisplay.setValue("test");
        break;
      case 5:
        ledDisplay.setValue("jklmnopq");
        break;
      case 6:
        ledDisplay.setValue("ERROR");
        break;
      case 7:
        ledDisplay.setValue("");
        break;
